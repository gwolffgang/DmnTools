...
public class HaustiereDmn {

	public String execute(final String tierNameDeutsch, final int besitzerNummer, final double rambaZamba) {
		return decisionHaustier(tierNameDeutsch, besitzerNummer, rambaZamba);
	}
